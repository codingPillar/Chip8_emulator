...
export class Processor {
    constructor(memory, graphicMem, keyPad, delayTimer, soundTimer) {
        this.registers = [];
    ...
    execRegisterArithmetic(opcode) {
        ...
        switch (opcode & 0x000F) {
            case 0x0000:
                ...
                break;
            case 0x0001:
                this.registers[firstRegIndex].update(this.registers[firstRegIndex].getValue() | this.registers[secondRegIndex].getValue());
                break;
            case 0x0002:
                this.registers[firstRegIndex].update(this.registers[firstRegIndex].getValue() & this.registers[secondRegIndex].getValue());
                break;
            ...
            case 0x0004:
                {
                    ...
                    if (value > 255)
                        this.registers[FLAG_REGISTER_INDEX].update(1);
                    else
            ...
            case 0x0005:
                {
                    ...
                    if (value > 0)
                        ...
                        this.registers[FLAG_REGISTER_INDEX].update(0); // reg[first] > reg[second]
                    this.registers[firstRegIndex].update(value);
                }
                break;
            case 0x0006:
            ...
            case 0x0007:
                {
                    ...
                    if (value > 0)
                        ...
                        this.registers[FLAG_REGISTER_INDEX].update(0); // reg[second] > reg[first]
                    this.registers[firstRegIndex].update(value);
                }
                break;
            case 0x000E:
    ...
    executeFTypeInstruction(opcode) {
        const regIndex = (opcode & 0x0F00) >> 8;
        switch (opcode & 0x00FF) {
            case 0x0007:
            ...
            case 0x000A:
                {
                    ...
                    if (keyValue === -1)
                        ...
                        this.registers[regIndex].update(keyValue);
                }
                break;
            case 0x0015:
            ...
            case 0x0018:
                ...
                break;
            case 0x001E:
                this.indexRegister.update(this.indexRegister.getValue() + this.registers[regIndex].getValue());
                break;
            case 0x0029:
                {
